  ...
  if (type === BtnTypes.Standard) {
    return (
      <div className="mt-10 hidden justify-center space-x-2 sm:flex md:justify-normal">
        <div className="className = 'flex border border-white gap-3 rounded-lg bg-zinc-900 px-4 py-2 text-white hover:bg-zinc-950 active:bg-zinc-800">
        <StoreLink
          ...
          logo={AppleLogo}
          target="_blank"
          className = 'flex border border-white gap-3 rounded-lg bg-zinc-900 px-4 py-2 text-white hover:bg-zinc-950 active:bg-zinc-800'
        />
        </div>
        <div className="className = 'flex border border-white gap-3 rounded-lg bg-zinc-900 px-4 py-2 text-white hover:bg-zinc-950 active:bg-zinc-800">
        <StoreLink
